      ...
      >
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-2">
            ...
            >
              👦🏻 안녕하세요! 프론트엔드 개발자{" "}
              <strong className="text-amber-600">최아리</strong>입니다.
              <br /> 프론트엔드 개발자로{" "}
              <strong className="text-amber-600">5년 6개월</strong>의 경력이
              있습니다. 캘리그라피 작가로 일했던 디자인 감각과 프론트엔드
              팀에서의 경험을 통해 웹 개발 및 디자인 시스템 구축을 주도하며
              업무를 성공적으로 이행하였습니다.개발자로써 다양한 프로젝트를
              경험하며 더 나은 사용자 경험을 위해 최선을 다하고 있습니다.
              프론트엔드 분야에서 더 많은 성장을 이루고, 혁신적인 솔루션을
              만들어낼수 있도록 노력하겠습니다.{" "}
              <strong className="text-amber-600">감사합니다 :-D</strong>
            </p>
