        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-2">
            ...
            <p
              ...
              className="py-2 leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300"
            >
              👦🏻 안녕하세요! 프론트엔드 개발자 <strong>최아리</strong>입니다.
              <br /> 지난 <strong>5년 6개월</strong> 동안 리즌디자인과
              후이즈시스템등 프론트엔드 책임 연구원과 선임 연구원으로
              활동하였습니다. 프론트엔드 팀에서의 경험을 통해 웹 개발 및 디자인
              시스템 구축을 주도하며 업무를 성공적으로 이행하였습니다.
              프론트엔드 개발자로써 다양한 프로젝트를 경험하며 더 나은 사용자
              경험을 위해 최선을 다하고 있습니다. 프론트엔드 분야에서 더 많은
              성장을 이루고, 혁신적인 솔루션을 만들어내는 일에 보람을 느끼고
              노력하고 있습니다.
            </p>
            ...
            >
              <Link href="/projects">
                <a className="btn-project w-full inline-flex justify-center text-white border-0 py-2 px-6 focus:outline-none hover:text-white rounded text-lg">
                  프로젝트 보러가기
                </a>
              </Link>
              <a
                ...
                target="_blank"
                style={{ color: "#fff" }}
                className="bg-teal-500 justify-center w-full inline-flex hover:bg-teal-600  border-0 py-2 px-6 focus:outline-none  rounded text-lg"
                rel="noreferrer"
              >
                이력서 보러가기
              </a>
