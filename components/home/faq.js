            ...
            >
              ...
              >
                <p>
                  {/* {index === openItemIndex ? "-" : "+"}{" "} */}
                  {index === 0 &&
                    "• 해당 포트폴리오는 JavaScript기반 React / Next / TypeScript기반으로 설계하였고 HTML와 CSS 프레임워크 Tailwind로 마크업과 스타일을 코드로 작성하고 UI를 보완하기 위해 lottie, slick, aos 등 라이브러리를 사용하여 제작하였습니다. 반응형은 모바일, 태블릿, 데스크탑 대응하고 있고 사용자 개선(UX)을 위해 라이트/다크 모드를 적용하였습니다. 프론트엔드(웹사이트) 호스팅 플랫폼 Vercel을 이용하여 배포, 배포 자동화, 빌드, 호스팅을 진행하였습니다. 꾸준히 보완하고 업데이트를 진행하고 있습니다."}
                  {index === 1 &&
